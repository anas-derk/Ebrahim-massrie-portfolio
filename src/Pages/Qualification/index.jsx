...
const Qualification = ({ pageTitle }) => {
    ...
    return (
        <Fragment>
            ...
            <div className="qualification pt-5">
                {/* Start Container */}
                <div className="container">
                    ...
                    <div className="qualification-details-box row">
                        ...
                        <div className="col-md-6">
                            ...
                            <section className="education-details-box details-box">
                                {/* Start Details Part */}
                                <div className="details-part p-4 bg-secondary">
                        ...
                        <div className="col-md-6">
                            ...
                            <section className="experience-details-box details-box">
                                {/* Start Details Part */}
                                <div className="details-part p-4 bg-secondary">
                                    <h6 className="duration">2013 - 2015</h6>
                                    <h5 className="level">Master In Computer Science</h5>
